...
import org.tron.java.proto.Contract.CreateSmartContract;
 ...
 * org.tron.java.core.contract.ContractFunction#toString()}</>
 *
 * @since jdk 1.8.0_231
 * @see org.tron.java.core.contract.ContractFunction
 * @see org.tron.java.proto.Common.SmartContract;
 */
...
public class Contract {
    ...
    //the amount of deposit STB, default is 0
    ...
    protected ByteString stbHash = ByteString.EMPTY;
    ...
    public ByteString getStbHash() {
        return stbHash;
    }

    public void setStbHash(ByteString stbHash) {
        this.stbHash = stbHash;
    }
   ...
   * @see org.tron.java.proto.Common.SmartContract.ABI.Entry;
