package org.tron.java.core;

import com.google.protobuf.InvalidProtocolBufferException;
import org.tron.java.abi.FunctionEncoder;
import org.tron.java.abi.datatypes.Function;
import org.tron.java.api.GrpcAPI.BytesMessage;

import org.tron.java.core.contract.Contract;
import org.tron.java.core.Constant;
import org.tron.java.api.WalletGrpc;
import org.tron.java.api.WalletSolidityGrpc;
import org.tron.java.core.contract.ContractFunction;
import org.tron.java.core.exceptions.IllegalException;
import org.tron.java.core.key.KeyPair;
import org.tron.java.core.transaction.TransactionBuilder;
import org.tron.java.crypto.SECP256K1;
import org.tron.java.proto.Chain.Transaction;

import org.tron.java.proto.Chain.Block;

import org.tron.java.proto.Common.SmartContract;

import org.tron.java.proto.Contract.TransferAssetContract;
import org.tron.java.proto.Contract.UncdBalanceContract;
import org.tron.java.proto.Contract.CdBalanceContract;
import org.tron.java.proto.Contract.TransferContract;
import org.tron.java.proto.Contract.VoteWitnessContract;
import org.tron.java.proto.Contract.TriggerSmartContract;
import org.tron.java.proto.Contract.AccountUpdateContract;
import org.tron.java.proto.Contract.AccountCreateContract;
import org.tron.java.proto.Contract.AssetIssueContract;
import org.tron.java.proto.Contract.SetAccountIdContract;
import org.tron.java.proto.Contract.UpdateAssetContract;
import org.tron.java.proto.Contract.UpdateBrokerageContract;
import org.tron.java.proto.Contract.ParticipateAssetIssueContract;
import org.tron.java.proto.Contract.UncdAssetContract;
import org.tron.java.proto.Contract.AccountPermissionUpdateContract;
import org.tron.java.proto.Response.TransactionExtention;
import org.tron.java.proto.Response.TransactionReturn;
import org.tron.java.proto.Response.NodeInfo;
import org.tron.java.proto.Response.WitnessList;
import org.tron.java.proto.Response.BlockExtention;
import org.tron.java.proto.Response.BlockListExtention;
import org.tron.java.proto.Response.Proposal;
import org.tron.java.proto.Response.Exchange;
import org.tron.java.proto.Response.DelegatedResourceMessage;
import org.tron.java.proto.Response.DelegatedResourceList;
import org.tron.java.proto.Response.DelegatedResourceAccountIndex;
import org.tron.java.api.GrpcAPI.NumberMessage;
import org.tron.java.api.GrpcAPI.EmptyMessage;
import org.tron.java.api.GrpcAPI.AccountAddressMessage;
import org.tron.java.api.GrpcAPI.AccountIdMessage;
import org.tron.java.api.GrpcAPI.BlockLimit;
import org.tron.java.api.GrpcAPI.PaginatedMessage;
import org.tron.java.utils.Base58Check;
...
import org.tron.java.crypto.tuwenitypes.Bytes32;
import org.bouncycastle.jcajce.provider.digest.Keccak;
import org.bouncycastle.jcajce.provider.digest.SHA256;
import org.bouncycastle.util.encoders.Hex;
import org.tron.java.proto.Response.NodeList;
import org.tron.java.proto.Response.TransactionInfoList;
import org.tron.java.proto.Response.TransactionInfo;
import org.tron.java.proto.Response.Account;
import org.tron.java.proto.Response.AccountResourceMessage;
import org.tron.java.proto.Response.AccountNetMessage;
import org.tron.java.proto.Response.ChainParameters;
import org.tron.java.proto.Response.AssetIssueList;
import org.tron.java.proto.Response.ProposalList;
import org.tron.java.proto.Response.ExchangeList;
import org.tron.java.proto.Response.TransactionSignWeight;
import org.tron.java.proto.Response.TransactionApprovedList;

import static org.tron.java.proto.Response.TransactionReturn.response_code.SUCCESS;
 ...
 * @see org.tron.java.core.contract.Contract
 * @see org.tron.java.proto.Chain.Transaction
 * @see org.tron.java.proto.Contract
 */
...
public class ApiWrapper {
    ...
    public ApiWrapper(String grpcEndpoint, String grpcEndpointSolidity, String hexPrivateKey, String apiKey) {
        ...
        Metadata.Key<String> key = Metadata.Key.of("STABILA-PRO-API-KEY", Metadata.ASCII_STRING_MARSHALLER);
    ...
    /**
     * The constuctor for main net. Use StabilaGrid as default
    ...
    /**
     * Cd balance to get energy or bandwidth, for 3 days
     * @param ownerAddress owner address
     * @param cdedBalance cded balance
     * @param cdedDuration cded duration
     * @param resourceCode Resource type, can be 0("BANDWIDTH") or 1("ENERGY")
     * @return TransactionExtention
     * @throws IllegalException if fail to cd balance
     */
    public TransactionExtention cdBalance(String ownerAddress, long cdedBalance, long cdedDuration, int resourceCode) throws IllegalException {

        return cdBalance(ownerAddress,cdedBalance,cdedDuration,resourceCode,"");
    }
     ...
     * @throws IllegalException if fail to cd balance
     */
    public TransactionExtention cdBalance(String ownerAddress, long cdedBalance, long cdedDuration, int resourceCode, String receiveAddress) throws IllegalException {
        ByteString rawFrom = parseAddress(ownerAddress);
        ByteString rawReceiveFrom = parseAddress(receiveAddress);
        CdBalanceContract cdBalanceContract=
                CdBalanceContract.newBuilder()
                        ...
                        .build();
        TransactionExtention txnExt = blockingStub.cdBalance2(cdBalanceContract);
    ...
    /**
     * Uncd balance to get STB back
     * @param ownerAddress owner address
     * @param resourceCode Resource type, can be 0("BANDWIDTH") or 1("ENERGY")
     * @return TransactionExtention
     * @throws IllegalException if fail to uncd balance
     */
    public TransactionExtention uncdBalance(String ownerAddress, int resourceCode) throws IllegalException {

        return uncdBalance(ownerAddress,resourceCode,"");
    }
     ...
     * @throws IllegalException if fail to uncd balance
     */
    public TransactionExtention uncdBalance(String ownerAddress, int resourceCode, String receiveAddress) throws IllegalException {

        UncdBalanceContract uncd =
                UncdBalanceContract.newBuilder()
                        .setOwnerAddress(parseAddress(ownerAddress))
                        .setResourceValue(resourceCode)
                        .setReceiverAddress(parseAddress(receiveAddress))
                        .build();

        TransactionExtention txnExt = blockingStub.uncdBalance2(uncd);
     ...
     * @param stbNum Define the price by the ratio of stb_num/num
     * @param icoNum Define the price by the ratio of stb_num/num
     ...
     * @param precision
     * @param cdedSupply HashMap<cdedDay, cdedAmount>
    ...
    public TransactionExtention createAssetIssue(String ownerAddress, String name, String abbr,
                                                 long totalSupply, int stbNum, int icoNum, long startTime, long endTime,
                                                 String url, long freeAssetNetLimit,
                                                 long publicFreeAssetNetLimit, int precision, HashMap<String, String> cdedSupply, String description) throws IllegalException {

        AssetIssueContract.Builder builder = assetIssueContractBuilder(ownerAddress, name, abbr, totalSupply, stbNum, icoNum, startTime, endTime, url, freeAssetNetLimit,
                publicFreeAssetNetLimit, precision, description);

        for (String daysStr : cdedSupply.keySet()) {
            String amountStr = cdedSupply.get(daysStr);
            long amount = Long.parseLong(amountStr);
            long days = Long.parseLong(daysStr);
            AssetIssueContract.CdedSupply.Builder cdedBuilder = AssetIssueContract.CdedSupply
                    .newBuilder();
            cdedBuilder.setCdedAmount(amount);
            cdedBuilder.setCdedDays(days);
            builder.addCdedSupply(cdedBuilder.build());
        }
    ...
    /**
     * Uncd a token that has passed the minimum cd duration
     * @param ownerAddress Owner address, default hexString
     * @return TransactionExtention
     * @throws IllegalException if fail to uncd asset
     */
    public TransactionExtention uncdAsset(String ownerAddress) throws IllegalException {
        ByteString bsOwnerAddress = parseAddress(ownerAddress);

        UncdAssetContract contract = createUncdAssetContract(bsOwnerAddress);

        TransactionExtention transactionExtention= blockingStub.uncdAsset2(contract);
     ...
     * @param stb transaction object
     * @return TransactionSignWeight
     */
    public TransactionSignWeight getTransactionSignWeight(Transaction stb) {

        TransactionSignWeight transactionSignWeight = blockingStub.getTransactionSignWeight(stb);
     ...
     */
    public TransactionApprovedList getTransactionApprovedList(Transaction stb) throws InvalidProtocolBufferException {

        TransactionApprovedList transactionApprovedList = blockingStub.getTransactionApprovedList(stb);
    ...
    public static UncdAssetContract createUncdAssetContract(ByteString address) {
